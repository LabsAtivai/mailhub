...
Também é "outro" (nunca "interessado"): corpo vazio ou quase vazio, respostas de uma linha sem conteúdo real (ex: só "ok", "recebido", assinatura sem texto), ou qualquer mensagem que não traga nenhum sinal concreto de interesse — na dúvida entre "interessado" e "outro", classifique como "outro".
