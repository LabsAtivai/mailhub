...
IMPORTANTE: resposta automática é SEMPRE "outro", mesmo quando o texto automático cita outro nome/e-mail pra redirecionar as mensagens (ex: "estarei ausente até dia X, favor direcionar para fulano@empresa.com", "esta conta foi desativada, encaminhar para fulano@empresa.com", "fulano não faz mais parte da empresa, direcionar para beltrano@empresa.com") — isso é um autoresponder mecânico (ausência/férias, conta desativada, funcionário desligado, caixa cheia), não uma pessoa encaminhando a conversa de verdade. Sinais de autoresponder: texto genérico/padronizado sem relação com o assunto específico enviado, ausência de saudação pessoal, menção a "resposta automática"/"esta é uma mensagem automática" em qualquer lugar do corpo. Prefixo "[EXTERNO]" no assunto é só uma tag de segurança de e-mail corporativo, não indica nada sobre o conteúdo.
